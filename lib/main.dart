          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Flexible(
                  child: Text(
                    "O'lchov birligini tanlang(default qiymat 'mm')",
                  ...
                  if (_selectedCategory == 0
                    ...
                    switch (_selectedCategory) {
                      case 0:
                        setState(() {
                          result =
                              CalculateKvadrat().periCal(inputA).toString();
                        });
                        break;
                      case 1:
                        setState(() {
                          result = CalculateTBurchak()
